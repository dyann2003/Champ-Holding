...
import { MapPin, Phone, Star, CheckCircle, Crown, ArrowRight, MessageCircle, Globe, Video, Mic, Users, Presentation, Award, Building, Calendar } from 'lucide-react';
  ...
  return (
    <div className="font-sans text-gray-800 bg-white selection:bg-rose-200">
        ...
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div className="leading-tight">
              <h1 className="font-heading-2 text-xl font-bold text-rose-950">
                HUYỀN TRANG
              </h1>
          ...
          <a href="tel:0916868165" className="hidden md:flex items-center gap-2 bg-rose-900 text-white px-5 py-2 rounded-full hover:bg-rose-800 transition shadow-lg border border-rose-800">
            <Phone size={16} className="animate-pulse" /><span className="font-cta font-bold">091.6868.165</span>
          </a>
        </div>
      </header>
      ...
      <section id="connect" className="py-24 bg-rose-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
           <div className="text-center mb-12"><h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-4">KẾT NỐI VỚI HUYỀN TRANG</h2><p className="text-rose-200">Cập nhật thông tin thị trường nhanh nhất</p></div>
           <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-16">
              <a href="https://www.facebook.com/huyentrangg165" target="_blank" className="flex items-center justify-center gap-3 bg-blue-600 text-white py-4 rounded-xl hover:bg-blue-700 transition font-bold shadow-lg"><FaFacebookF /> Facebook</a>
              <a href="https://www.tiktok.com/@huyentrang.land" target="_blank" className="flex items-center justify-center gap-3 bg-black text-white py-4 rounded-xl hover:bg-gray-800 transition font-bold shadow-lg border border-gray-700"><FaTiktok /> TikTok</a>
              <a href="https://zalo.me/changchiny" target="_blank" className="flex items-center justify-center gap-3 bg-blue-500 text-white py-4 rounded-xl hover:bg-blue-600 transition font-bold shadow-lg"><SiZalo /> Chat Zalo</a>
           </div>
           <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 md:p-12 border border-white/20">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <a
                  ...
                  className="bg-white p-6 rounded-xl shadow-xl flex flex-col items-center text-center group hover:-translate-y-1 transition duration-300"
                >
                  <div className="w-16 h-16 rounded-full overflow-hidden mb-4 shadow-md group-hover:scale-110 transition">
                    <img
                      src="https://s480-ava-grp-talk.zadn.vn/7/d/e/6/4/480/2bc64f038c85c78611a2a7a10e6d9879.jpg"
                      alt="Masteri Sky Quarter"
                      className="w-full h-full object-cover"
                    />
                  </div>

                  <h4 className="font-heading font-semibold text-lg text-gray-900 mb-2">
                    MASTERI SKY QUARTER ĐAN PHƯỢNG
                  </h4>

                  <span className="text-blue-600 font-bold uppercase text-sm border-b-2 border-blue-600 pb-1">
                    Tham gia ngay
                  </span>
                </a>
                 ...
                 <a
                  ...
                  >
                    <div className="w-16 h-16 rounded-full overflow-hidden mb-4 shadow-md group-hover:scale-110 transition">
                      <img
                        src="https://ava-grp-talk.zadn.vn/c/5/8/8/4/360/05a15e1110cd0725ad1b5508ce143849.jpg"
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-heading text-2xl font-bold tracking-tight">HUYỀN TRANG <span className="text-amber-500">Champ Holding</span></span></div>
          ...
          <div>
             ...
             <ul className="space-y-4">
                <li className="flex items-start gap-3"><Phone className="text-amber-500 shrink-0 mt-1" size={20} /><div><div className="font-cta font-bold text-lg text-amber-500">091.6868.165 - 087.872.8888</div></div></li>
